...
public class Jpa23052023Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (PromedioProveedorDTO pr : ps.promedioProveedor()) {
            System.out.println(pr);
        }
        System.out.println("********************************\n");

        System.out.println("Obtener la suma de inventario (UnitsInStock) " +
                "por SupplierID De la tabla de productos (Products)");
        for (SumaInventarioDTO s : ps.sumaInventario()){
            System.out.println(s);
        }

        System.out.println("********************************\n");

        System.out.println("Obtener el precio promedio de los productos " +
                "por categoria sin contar con los productos descontinuados (Discontinued)");

        for (PrecioPromedioCategoriaDTO pp : ps.PrecioPromedioCategoria()){
